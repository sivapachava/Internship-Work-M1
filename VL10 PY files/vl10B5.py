...
g.add((Switch, sosa.observes, Literal("It indicates belt reaches to top point on the Z- Axis on VL10 machine of the IT'm factory.", lang=("en"))))
...
g.add((machine, dct.title, Literal("Z-Axis top limit Status")))
g.add((machine, dct.description, Literal("Indicates the status of the Z axis at the top limit point on VL10 machine of the IT'm factory. Normally the switch is in close and the status is true, if belt reaches to top limit point then the switch is opened and the status is false.", lang=("en"))))
...
g.add((Operation, hctl.hasTarget, Literal("https://ci.mines-stetienne.fr/simu/storageRack/properties/AxeZ_Fdc_Haut_B5")))
g.add((machine, td.isObservable, Literal("False")))
g.add((machine, td.name, Literal("AxeZ_Fdc_Haut_B5")))

print(g.serialize(r"C:\Users\Siva Ratnam Pachava\OneDrive\Desktop\InternshipM1\VL10\B5.ttl" , format='ttl'))