...
Motor = URIRef("https://ci.mines-stetienne.fr/kg/itmfactory/vl10/M2")
...
g.add((machine, dct.description, Literal("It is used to read the speed of the cartesian motor on X-Axis", lang=("en"))))
...
g.add((Operation, hctl.hasTarget, Literal("http://localhost:3001/ns=2;s=Channel_test2.Magasin%20vertical.Vitesse_Deplacement_X")))
g.add((machine, td.isObservable, Literal("False")))
g.add((machine, td.name, Literal("Vitesse_Deplacement_X")))

print(g.serialize(r"C:\Users\Siva Ratnam Pachava\OneDrive\Desktop\InternshipM1\VL10\M2.ttl" , format='turtle'))