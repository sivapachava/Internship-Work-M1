...
Sensor = URIRef("https://ci.mines-stetienne.fr/kg/itmfactory/vl10/B15")
g.add((Sensor, rdfs.label, Literal("sensor")))
g.add((Sensor,  skos.prefLabel, Literal("B15")))
g.add((Sensor, rdfs.comment, Literal("It is used to detect bottle on storage rack and to measure distance of the bottle from sensor", lang=("en"))))
...
g.add((machine, dct.title, Literal("detect bottle on storage rack")))
g.add((machine, dct.description, Literal("It is used to detect bottle on storage rack and to measure distance of the bottle from sensor", lang=("en"))))
...
g.add((Operation, hctl.hasTarget, Literal("https://ci.mines-stetienne.fr/simu/storageRack/properties/Mesure_distance_Pot")))
g.add((machine, td.isObservable, Literal("False")))
g.add((machine, td.name, Literal("Mesure_distance_Pot")))

print(g.serialize(r"C:\Users\Siva Ratnam Pachava\OneDrive\Desktop\InternshipM1\VL10\B15.ttl", format='turtle'))