...
Motor = URIRef("https://ci.mines-stetienne.fr/kg/itmfactory/vl10/M3")
...
g.add((Motor, rdfs.comment, Literal("Stepper motor for Y-Axis moving on the VL10 of the IT'm factory", lang=("en"))))
...
g.add((machine, dct.description, Literal("It is used to read the position of the cartesian motor on Y-Axis", lang=("en"))))
...
print(g.serialize(r"C:\Users\Siva Ratnam Pachava\OneDrive\Desktop\InternshipM1\VL10\M3.ttl" , format='turtle'))