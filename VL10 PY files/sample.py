...
with open('./VL10 Labels.csv', 'r') as file:
    ...
    for row in csvreader:
        ...
        moreinfo = Literal(row[11], lang=("en"))
        ...
        Sensor = URIRef("https://ci.mines-stetienne.fr/kg/itmfactory/vl10/sample" + "/" + row[0])
        ...
        print(g.serialize(r"C:\Users\Siva Ratnam Pachava\OneDrive\Desktop\New folder (3)" + "/" + row[0] + ".ttl" , format="ttl"))
