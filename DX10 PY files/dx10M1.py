...
Motor = URIRef("https://ci.mines-stetienne.fr/kg/itmfactory/dx10/M1")
...
g.add((Motor, rdfs.comment, Literal("Gear motor for conveyor belt on the DX10 of the IT'm factory", lang=("en"))))
...
g.add((machine, dct.title, Literal("Etape conduite")))
g.add((machine, dct.description, Literal("It is used to read and write the speed of the conveyor belt on the DX10 Machine of the IT'm factory.", lang=("en"))))
...
g.add((Operation, hctl.hasTarget, Literal("https://ci.mines-stetienne.fr/simu/fillingWorkshop/properties/Etapeconduite")))
g.add((machine, td.isObservable, Literal("False")))
g.add((machine, td.name, Literal("Etapeconduite")))

print(g.serialize(r"C:\Users\Siva Ratnam Pachava\OneDrive\Desktop\InternshipM1\DX10\M1.ttl" , format='turtle'))