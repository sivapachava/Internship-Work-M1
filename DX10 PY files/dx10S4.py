...
Cylinder = URIRef("https://ci.mines-stetienne.fr/kg/itmfactory/dx10/S4")
...
g.add((Cylinder, skos.prefLabel, Literal("S4")))
...
g.add((Cylinder, sosa.observes,  Literal("Indicates movable part (hopper) reaches to end position on backward direction on DX10 machine of the IT'm factory.", lang=("en"))))
...
g.add((machine, dct.title, Literal("Axis_Fill_Pulse")))
g.add((machine, dct.description, Literal("Indicates tank reaches to ideal/intial position on backward direction on DX10 machine of the IT'm factory.", lang=("en"))))
...
g.add((Operation, hctl.hasTarget, Literal("https://ci.mines-stetienne.fr/simu/fillingWorkshop/properties/Axis_Fill_Pulse")))
g.add((machine, td.isObservable, Literal("False")))
g.add((machine, td.name, Literal("Axis_Fill_Pulse")))

print(g.serialize(r"C:\Users\Siva Ratnam Pachava\OneDrive\Desktop\InternshipM1\DX10\S4.ttl", format='turtle'))