...
Cylinder = URIRef("https://ci.mines-stetienne.fr/kg/itmfactory/dx10/S3")
...
g.add((Cylinder, skos.prefLabel, Literal("S3")))
...
g.add((Cylinder, sosa.observes,  Literal("Indicates movable part (hopper) reaches to ideal/intial position on DX10 machine of the IT'm factory.", lang=("en"))))
...
g.add((machine, dct.title, Literal("Came de prise d'origine")))
...
g.add((Operation, hctl.hasTarget, Literal("https://ci.mines-stetienne.fr/simu/fillingWorkshop/properties/Camedeprised'origine")))
g.add((machine, td.isObservable, Literal("False")))
g.add((machine, td.name, Literal("Came de prise d'origine")))

print(g.serialize(r"C:\Users\Siva Ratnam Pachava\OneDrive\Desktop\InternshipM1\DX10\S3.ttl", format='turtle'))