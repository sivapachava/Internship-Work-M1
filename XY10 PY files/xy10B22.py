...
g.add((Switch, sosa.observes, Literal("It indicates the belt is reaches to the intial position on the Z axis on XY10 machine of the IT'm factory", lang=("en"))))
...
g.add((machine, dct.title, Literal("ZAxis Reference")))
...
g.add((Operation, hctl.hasTarget, Literal("https://ci.mines-stetienne.fr/simu/packagingWorkshop/properties/AxeZ_Ref")))
g.add((machine, td.isObservable, Literal("False")))
g.add((machine, td.name, Literal("AxeZ_Ref")))

print(g.serialize(r"C:\Users\Siva Ratnam Pachava\OneDrive\Desktop\InternshipM1\XY10\B22.ttl" , format='ttl'))