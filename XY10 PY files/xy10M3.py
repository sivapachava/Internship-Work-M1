...
Motor = URIRef("https://ci.mines-stetienne.fr/kg/itmfactory/xy10/M3")
...
g.add((Motor,  skos.prefLabel, Literal("M3")))
g.add((Motor, rdfs.comment, Literal("Stepper motor for Y-Axis moving on the XY10 of the IT'm factory", lang=("en"))))
...
g.add((machine, dct.title, Literal("Position Y")))
g.add((machine, dct.description, Literal("It is used to read the position of the cartesian motor on Y-Axis on the XY10 Machine of the IT'm factory.", lang=("en"))))
...
g.add((Operation, hctl.hasTarget, Literal("https://ci.mines-stetienne.fr/simu/storageRack/properties/Axe_Y_position_Int")))
g.add((machine, td.isObservable, Literal("False")))
g.add((machine, td.name, Literal("Axe_Y_position_Int")))

print(g.serialize(r"C:\Users\Siva Ratnam Pachava\OneDrive\Desktop\InternshipM1\XY10\M3.ttl" , format='turtle'))