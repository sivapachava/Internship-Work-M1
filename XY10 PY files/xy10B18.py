...
g.add((Switch, sosa.observes, Literal("It indicates belt reaches to top limit point on the Z Axis on XY10 machine of the IT'm factory", lang=("en"))))
...
g.add((machine, dct.title, Literal("ZAxis Top Limit")))
g.add((machine, dct.description, Literal("Indicates the status of the Z axis on XY10 machine of the IT'm factory at the top limit point. Normally the switch is in close and the status is true, if belt reaches to top limit point then the switch is opened and the status is false.", lang=("en"))))
...
g.add((Operation, hctl.hasTarget, Literal("https://ci.mines-stetienne.fr/simu/packagingWorkshop/properties/AxeZ_Fdc_Haut_B18")))
g.add((machine, td.isObservable, Literal("False")))
g.add((machine, td.name, Literal("AxeZ_Fdc_Haut_B18")))

print(g.serialize(r"C:\Users\Siva Ratnam Pachava\OneDrive\Desktop\InternshipM1\XY10\B18.ttl" , format='ttl'))