...
Motor = URIRef("https://ci.mines-stetienne.fr/kg/itmfactory/xy10/M2")
...
g.add((Motor, rdfs.comment, Literal("Stepper motor for X-Axis moving on the XY10 of the IT'm factory", lang=("en"))))
...
g.add((machine, dct.title, Literal("Position X")))
g.add((machine, dct.description, Literal("It is used to read the position of the cartesian motor on X-Axis on the XY10 Machine of the IT'm factory.", lang=("en"))))
...
g.add((Operation, hctl.hasTarget, Literal("https://ci.mines-stetienne.fr/simu/storageRack/properties/Axe_X_position_Int")))
g.add((machine, td.isObservable, Literal("False")))
g.add((machine, td.name, Literal("Axe_X_position_Int")))

print(g.serialize(r"C:\Users\Siva Ratnam Pachava\OneDrive\Desktop\InternshipM1\XY10\M2.ttl" , format='turtle'))