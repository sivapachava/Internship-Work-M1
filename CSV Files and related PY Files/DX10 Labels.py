...
with open('./DX10 Labels.csv', 'r') as file:
    ...
    for row in csvreader:
        ...
        Sensor = URIRef("https://ci.mines-stetienne.fr/kg/itmfactory/dx10" + "/" + row[0])
        ...
        print(g.serialize(r"C:\Users\Siva Ratnam Pachava\OneDrive\Desktop\InternshipM1\CSV Files and related PY Files\DX10 Labels turtle files" + "/" + row[0] + ".ttl" , format="ttl"))
