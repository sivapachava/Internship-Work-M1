...
with open('./VL10 Labels.csv', 'r') as file:
    ...
    for row in csvreader:
        ...
        Sensor = URIRef("https://ci.mines-stetienne.fr/kg/itmfactory/vl10" + "/" + row[0])
        ...
        print(g.serialize(r"C:\Users\Siva Ratnam Pachava\OneDrive\Desktop\InternshipM1\CSV Files and related PY Files\VL10 Labels turtle files" + "/" + row[0] + ".ttl" , format="ttl"))
