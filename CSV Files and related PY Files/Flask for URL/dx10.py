...
def dx10B1():
    ...
    with open("C:\\Users\\Siva Ratnam Pachava\\OneDrive\\Desktop\\InternshipM1\\CSV Files and related PY Files\\DX10 thing desc file.csv", 'r') as file:
