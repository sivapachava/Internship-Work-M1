...
g.add((Sensor, rdfs.comment, Literal("System for placing jars/bottles in trays and pieces on boxes/pallets.", lang = ("en"))))
g.add((Sensor, td.hasSecurityConfiguration, last))
g.add((last, rdf.type, wotsec.BasicSecurityScheme))
               
with open('./XY10 thing desc file.csv', 'r') as file:
...
print(g.serialize(r"C:\Users\Siva Ratnam Pachava\OneDrive\Desktop\InternshipM1\CSV Files and related PY Files\thing desc files\xy10td.ttl", format="ttl"))